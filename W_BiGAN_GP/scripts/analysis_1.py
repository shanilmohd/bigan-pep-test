...
#%%variables
path_data = "/Users/mohamedshanil/Desktop/iitb_ML_project/bigan-pep-test/data_master/"
fasta_AMPs = "/Users/mohamedshanil/Desktop/iitb_ML_project/bigan-pep-test/data_master/amps/dbaasp/dbaasp_APR_processed.fasta"
fasta_AMYs ="/Users/mohamedshanil/Desktop/iitb_ML_project/bigan-pep-test/data_master/amyloid/amys_uniqueAI4AMP_processedtotrain.fasta"


path_result = "/Users/mohamedshanil/Desktop/iitb_ML_project/bigan-pep-test/W_BiGAN_GP/results/"
...
# z = z.to(device)
# generated_seqs = "/Users/mohamedshanil/Desktop/iitb_ML_project/bigan-pep-test/data_master/final_generated_seq.fasta"
# util.write_fasta(generated_seqs, path_result + "seqs_generated"+str(batch_generate)+".fasta")

### write AMPs and AMYs shuffled seqs
seq_object = util.get_shuffled_sample(fasta_AMPs,num_seqs = 128)
util.write_fasta(seq_object, path_result + "seqs_realAMPs.fasta")

seq_object = util.get_shuffled_sample(fasta_AMYs,num_seqs = 128)
util.write_fasta(seq_object, path_result + "seqs_realAMYs.fasta")

#%% analsis and plot
###violin plot of phy_chem properties
l_fasta = [path_result+"seqs_generated.fasta",
           path_result+"seqs_realAMPs.fasta",
           path_result+"seqs_realAMYs.fasta",
...
seq_object = util.get_shuffled_sample(fasta_AMPs,num_seqs = 128, amidion_tag= True)
util.write_fasta(seq_object, path_result + "seqs_realAMPs_amidation_tag.fasta")
l_fasta[1] = path_result+"seqs_realAMPs_amidation_tag.fasta" 
