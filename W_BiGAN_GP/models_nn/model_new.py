...
class Encoder(nn.Module):
    def __init__(self, filter_max):
        ...
        f = int(filter_max/32)
        self.model = nn.Sequential(
            Con2dLr_Block(1, f, (10, 4), (1, 1), (2, 2), bias=False),
            Con2dLr_Block(f, f * 2, (8, 3), (1, 1), (0, 1), bias=False),
            Con2dLr_Block(f * 2, f * 4, (7, 3), (1, 1), (0, 0), bias=False),
            Con2dLr_Block(f * 4, f * 8, (6, 3), (1, 1), (0, 0), bias=False),
            Con2dLr_Block(f * 8, f * 16, (5, 2), (1, 1), (0, 0), bias=False),
            nn.Conv2d(f * 16, filter_max , (3, 2), (1, 1), (0, 0), bias=False),
        )
